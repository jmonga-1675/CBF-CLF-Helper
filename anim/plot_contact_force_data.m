function plot_contact_force_data(t,x,u)
% savename=['simulation\Aug_18_data\ctrl13_Nsteps10_test_no33_test_file_Aug_18'];
% load(savename);
...
savename='simulation\paper_figs\contact_force';
...
% fig.PaperUnits = 'inches';
% fig.PaperPosition = [0 0 5 2];
savename='simulation\paper_figs\friction';
% saveas(gcf,savename,'jpg');
pos=[0 0 9.6/2 2];
set(gcf, 'PaperPosition', pos); 
set(gcf, 'PaperSize', pos(3:4));

function plot_stick_fig%(t,x,ts,l_min_t,l_max_t,ground)
...
figure_x_limits = [-0.5 5];%[-1.5 4];
figure_y_limits = [-0.1 1.5];%
...
% savename='simulation\Aug_18_data\stick_fig_1';
% saveas(gcf,savename,'jpg');
savename='simulation\paper_figs\stick_fig_1';
set(gca,'visible','off');
pos=[0 0 7 4];
